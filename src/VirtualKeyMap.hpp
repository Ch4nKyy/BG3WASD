...
private:
    ...
    */
    static inline std::map<std::string, std::vector<int>> VIRTUAL_KEY_MAP{
        ...
        { "key:print", { VK_PRINT, SDL_SCANCODE_PRINTSCREEN, SDLK_PRINTSCREEN } },
        ...
        { "key:lwin", { VK_LWIN, SDL_SCANCODE_LGUI, SDLK_LGUI } },
        { "key:rwin", { VK_RWIN, SDL_SCANCODE_RGUI, SDLK_RGUI } },
        { "key:apps", { VK_APPS, SDL_SCANCODE_APPLICATION, SDLK_APPLICATION } },
        { "key:sleep", { VK_SLEEP, SDL_SCANCODE_SLEEP, SDLK_SLEEP } },
        { "key:numpad0", { VK_NUMPAD0, SDL_SCANCODE_KP_0, SDLK_KP_0 } },
        { "key:numpad1", { VK_NUMPAD1, SDL_SCANCODE_KP_1, SDLK_KP_1 } },
        { "key:numpad2", { VK_NUMPAD2, SDL_SCANCODE_KP_2, SDLK_KP_2 } },
        { "key:numpad3", { VK_NUMPAD3, SDL_SCANCODE_KP_3, SDLK_KP_3 } },
        { "key:numpad4", { VK_NUMPAD4, SDL_SCANCODE_KP_4, SDLK_KP_4 } },
        { "key:numpad5", { VK_NUMPAD5, SDL_SCANCODE_KP_5, SDLK_KP_5 } },
        { "key:numpad6", { VK_NUMPAD6, SDL_SCANCODE_KP_6, SDLK_KP_6 } },
        { "key:numpad7", { VK_NUMPAD7, SDL_SCANCODE_KP_7, SDLK_KP_7 } },
        { "key:numpad8", { VK_NUMPAD8, SDL_SCANCODE_KP_8, SDLK_KP_8 } },
        { "key:numpad9", { VK_NUMPAD9, SDL_SCANCODE_KP_9, SDLK_KP_9 } },
        { "key:multiply", { VK_MULTIPLY, SDL_SCANCODE_KP_MULTIPLY, SDLK_KP_MULTIPLY } },
        { "key:add", { VK_ADD, SDL_SCANCODE_KP_PLUS, SDLK_KP_PLUS } },
        { "key:separator", { VK_SEPARATOR, SDL_SCANCODE_SEPARATOR, SDLK_SEPARATOR } },
        { "key:subtract", { VK_SUBTRACT, SDL_SCANCODE_KP_MINUS, SDLK_KP_MINUS } },
        { "key:decimal", { VK_DECIMAL, SDL_SCANCODE_KP_DECIMAL, SDLK_KP_DECIMAL } },
        { "key:divide", { VK_DIVIDE, SDL_SCANCODE_KP_DIVIDE, SDLK_KP_DIVIDE } },
        ...
        { "key:scroll", { VK_SCROLL, SDL_SCANCODE_SCROLLLOCK, SDLK_SCROLLLOCK } },
        ...
        { "key:volume_mute", { VK_VOLUME_MUTE, SDL_SCANCODE_AUDIOMUTE, SDLK_AUDIOMUTE } },
        ...
        { "key:media_next_track", { VK_MEDIA_NEXT_TRACK, SDL_SCANCODE_AUDIONEXT, SDLK_AUDIONEXT } },
        { "key:media_prev_track", { VK_MEDIA_PREV_TRACK, SDL_SCANCODE_AUDIOPREV, SDLK_AUDIOPREV } },
        { "key:media_stop", { VK_MEDIA_STOP, SDL_SCANCODE_AUDIOSTOP, SDLK_AUDIOSTOP } },
        { "key:media_play_pause", { VK_MEDIA_PLAY_PAUSE, SDL_SCANCODE_AUDIOPLAY, SDLK_AUDIOPLAY } },
        { "key:launch_mail", { VK_LAUNCH_MAIL, SDL_SCANCODE_MAIL, SDLK_MAIL } },
